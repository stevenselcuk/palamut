...
class ErrorSuppressionTest extends TestCase
{
    ...
    public function testSuppressWarning()
    {
        ...
        // Process with a docblock suppression (deprecated syntax).
        $content = '<?php '.PHP_EOL.'/** @codingStandardsIgnoreStart */'.PHP_EOL.'//TODO: write some code'.PHP_EOL.'/** */'; id:31 @codingStandardsIgnoreEnd
        $file    = new DummyFile($content, $ruleset, $config);
        $file->process();
    ...
    public function testSuppressFile()
    {
        ...
        $content = '<?php '.PHP_EOL.'/* phpcs:ignoreFile */'.PHP_EOL.'//TODO: write some code'; id:40
        $file    = new DummyFile($content, $ruleset, $config);
        $file->process();
        ...
        $content = '<?php '.PHP_EOL.'/*'.PHP_EOL.' phpcs:ignoreFile'.PHP_EOL.' */'.PHP_EOL.'//TODO: write some code'; id:6
        $file    = new DummyFile($content, $ruleset, $config);
        $file->process();
        ...
        $content = '<?php '.PHP_EOL.'/* @codingStandardsIgnoreFile */'.PHP_EOL.'//TODO: write some code'; id:14
        $file    = new DummyFile($content, $ruleset, $config);
        $file->process();
