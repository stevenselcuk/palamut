...
if ( ! class_exists( 'Palamut_Component_Loader' ) ) {
	/**
	 * Template loader.
	 *
	 ...
	 * @author  Gary Jones
	 */
	class Palamut_Component_Loader {
		/**
		 ...
		 * @var string
		 */
		protected $filter_prefix = 'palamut';
		/**
		 ...
		 * @var string
		 */
		protected $plugin_directory = PALAMUT_PATH;
		/**
		 ...
		 * @var string
		 */
		protected $plugin_template_directory = '/includes/components/';
		/**
		 ...
		 * @return string
		 */
		public function component( $slug, $name = null, $load = true ) {
