 ...
 * @type {string[]}
*/
const ALLOWED_BLOCKS = [ 'palamut/accordion-item' ];
...
const getCount = memoize( ( count ) => {
	return times( count, () => [ 'palamut/accordion-item' ] );
} );
			...
			<Fragment>
				...
				<div className={ className }>
					<InnerBlocks
						...
						<div className="components-palamut-add-accordion-item">
							<IconButton
								isLarge
								className="components-palamut-add-accordion-item__button"
								...
								onClick={ () => {
									if ( items[0].innerBlocks ) {
										...
										let created = createBlock( 'palamut/accordion-item', copyAttributes );
