				...
				>
					<div
						className={ classnames( {
							...
							'palamut-post-grid-items' : 'palamut-post-grid-items'
						} ) }
					>
							...
							>
								{
									displayPostImage && post.featured_image_src !== undefined && post.featured_image_src ? (
										<div class="palamut-block-post-grid-image">
								...
								<div class="palamut-block-post-grid-text">
									...
									<div class="palamut-block-post-grid-byline">
										{ displayPostAuthor && post.author_info.display_name &&
											<div class="palamut-block-post-grid-author"><a class="palamut-text-link" target="_blank" href={ post.author_info.author_link }>{ post.author_info.display_name }</a></div>
										}

										{ displayPostDate && post.date_gmt &&
											<time dateTime={ moment( post.date_gmt ).utc().format() } className={ 'palamut-block-post-grid-date' }>
									...
									<div class="palamut-block-post-grid-excerpt">
										...
										{ displayPostLink &&
											<p><a class="palamut-block-post-grid-link palamut-text-link" href={ post.link } target="_blank" rel="bookmark">{ readMoreText }</a></p>
										}
									</div>
								</div>
							</article>
