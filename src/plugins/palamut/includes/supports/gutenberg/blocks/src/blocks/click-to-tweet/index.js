...
const settings = {
		...
		from: [
			{
				...
				transform: ( { content } ) => createBlock( `palamut/${ name }`, {
					content: content,
				} ),
			},
			{
	...
	save( { attributes } ) {
		...
		const textClasses = classnames( 'wp-block-palamut-click-to-tweet__text', {
		...
		const buttonClasses = classnames( 'wp-block-palamut-click-to-tweet__twitter-btn', {
