...
const blockAttributes = {
	title: {
		source: 'children',
		selector: '.wp-block-palamut-pricing-table-item__title',
	},
	features: {
		source: 'children',
		selector: '.wp-block-palamut-pricing-table-item__features',
	},
	currency: {
		type: 'array',
		source: 'children',
		selector: '.wp-block-palamut-pricing-table-item__currency',
	},
	amount: {
		type: 'array',
		source: 'children',
		selector: '.wp-block-palamut-pricing-table-item__amount',
	},
	backgroundColor: {
		type: 'string',
	},
...
const settings = {
	...
	transforms: {
		from: [
			{
				type: 'raw',
				selector: 'div.wp-block-palamut-pricing-table',
				schema: {
					div: {
						classes: [ 'wp-block-palamut-pricing-table' ],
					},
				},
			},
		],
