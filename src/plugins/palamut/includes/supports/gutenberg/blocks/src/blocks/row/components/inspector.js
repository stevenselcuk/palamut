								...
								<PanelBody title={ __( 'Layout' ) } initialOpen={ false }>
									<div className="components-palamut-visual-dropdown">
										...
										{ map( layoutOptions[ selectedRows ], ( { name, key, icon, cols } ) => (
											<Tooltip text={ name }>
												<div className={ ( key == layout ) ? 'components-palamut-visual-dropdown__button-wrapper is-selected' : 'components-palamut-visual-dropdown__button-wrapper' }>
													<Button
														className={ ( key == layout ) ? 'components-palamut-visual-dropdown__button components-palamut-visual-dropdown__button--selected' : 'components-palamut-visual-dropdown__button' }
														isSmall
														onClick={ () => {
