 ...
 * Constants
 */
const ALLOWED_BLOCKS = [ 'core/button', 'core/paragraph', 'core/heading', 'core/image', 'palamut/highlight', ];

const TEMPLATE = [
	[ 'palamut/icon', { hasContentAlign: false } ],
...
class Edit extends Component {
	...
	render() {
		...
		const classes = classnames(
			className, {
				[ `palamut-feature-${ palamut.id }` ] : palamut && ( typeof palamut.id != 'undefined' ),
			}
		);
