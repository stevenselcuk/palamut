...
class ResponsiveTabsControl extends Component {
	...
	render() {
		...
		return (
			<Fragment>
				<TabPanel
					className="components-base-control components-palamut-responsive__tabs"
					...
					tabs={ [
						{
							...
							className: 'components-palamut-responsive__tabs-item components-palamut-responsive__tabs-item--desktop',
						},
						{
							name: 'mobile',
							title: icons.mobile,
							className: 'components-palamut-responsive__tabs-item components-palamut-responsive__tabs-item--mobile',
						},
					] }>
					{
						( tab ) => {
