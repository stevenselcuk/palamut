...
const blockAttributes = {
	title: {
		type: 'string',
		selector: '.wp-block-palamut-alert__title',
	},
	value: {
		type: 'array',
		source: 'children',
		selector: '.wp-block-palamut-alert__text',
		default: [],
	},
	backgroundColor: {
		type: 'string',
		...
		from: [
			{
				...
				transform: ( { content } ) => {
					return createBlock( `palamut/${ name }`, { value: content } );
				},
			},
			{
				type: 'raw',
				selector: 'div.wp-block-palamut-alert',
				schema: {
					div: {
						classes: [ 'wp-block-palamut-alert' ],
					},
				},
			},
			{
		...
		return (
			...
			>
				{ ! RichText.isEmpty( title ) &&
					<RichText.Content
						tagName="p"
						className="wp-block-palamut-alert__title"
						value={ title }
					/>
				}
				{ ! RichText.isEmpty( value ) &&
					<RichText.Content
						tagName="p"
						className="wp-block-palamut-alert__text"
						value={ value }
					/>
				}
			</div>
