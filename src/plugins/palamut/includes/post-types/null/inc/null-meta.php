...
/**
 * [palamut_register_portfolio_metabox description]
 *
 * @method palamut_register_portfolio_metabox
 *
 * @since
 */
function palamut_register_portfolio_metabox() {
	$prefix = 'pala_porfolio_';

	$cmb_portfolio = new_cmb2_box(
		array(
			'id'           => $prefix . 'metabox',
			'title'        => esc_html__( 'Portfolio Custom Fields', 'palamut' ),
...
add_action( 'cmb2_admin_init', 'palamut_register_portfolio_metabox' );
