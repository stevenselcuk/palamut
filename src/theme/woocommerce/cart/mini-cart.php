...
$empty_class = ( WC()->cart->is_empty() ) ? ' class="palamut-cart-panel-empty"' : '';
?>

<div id="palamut-cart-panel"<?php echo esc_attr( $empty_class ); ?>>

	<div class="palamut-cart-panel-list-wrap">
		...
		<ul class="cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
			...
			<?php if ( ! WC()->cart->is_empty() ) : ?>
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						if ( ! $_product->is_visible() ) {
							$product_name = '<span class="palamut-cart-panel-product-title">' . $product_name . '</span>';
						} else {
							$product_permalink = esc_url( $product_permalink );
							$thumbnail         = '<a href="' . $product_permalink . '">' . $thumbnail . '</a>';
							$product_name      = '<a href="' . $product_permalink . '" class="palamut-cart-panel-product-title">' . $product_name . '</a>';
						}
				...
				<li id="palamut-cart-panel-item-<?php echo esc_attr( $cart_item['product_id'] ); ?>" class="<?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<div class="palamut-cart-panel-item-price">
...
?>
	...
	<footer class="palamut-cart-panel-summary">
		...
		<a href="<?php echo esc_url( $url ); ?>" class="checkout btn wc-forward">
			...
			<span class="palamut-cart-panel-summary-subtotal">
