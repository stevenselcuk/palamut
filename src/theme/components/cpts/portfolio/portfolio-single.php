...
<article id="project-<?php the_ID(); ?>" class="<?php echo esc_attr( prefix_portfolio_class() ); ?>" itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost" itemid="<?php echo esc_url( get_the_permalink() ); ?>" content="<?php echo esc_attr( get_the_title() ); ?>">
	<!-- Start .entry-header-->
