...
?>
	<!-- Start: #main -->
	<main id="content" class="site-content portfolio-loop portfolio--carson <?php echo esc_attr( $layout ); ?>" role="main" itemprop="mainContentOfPage" itemscope="itemscope" itemtype="http://schema.org/Blog">
		<?php
