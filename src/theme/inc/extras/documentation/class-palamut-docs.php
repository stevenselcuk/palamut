...
class Palamut_Docs {
	...
	public function enqueue() {
		...
		if ( ! is_customize_preview() ) {
			wp_enqueue_style( 'prefix-documentation', __PRE_THEME_DIR_URL . '/inc/extras/documentation/assets/css/guide.min.css', false, '1.0', false );
			wp_enqueue_script( 'marked', __PRE_THEME_DIR_URL . '/inc/extras/documentation/assets/js/src/marked.js', false, '1.0' );
			wp_enqueue_script( 'prefix-documentation', __PRE_THEME_DIR_URL . '/inc/extras/documentation/assets/js/src/guide.js', array('marked'), '1.0', false );
		}
	}
	...
	public function render() {
		...
		<div id="huh-container" class="huh-container">
			<div class="huh-container__header" id="huh-header">
				<h4 class="huh-container__header-text"> <?php echo esc_html__( 'WordPress Theme', 'textdomain' ); ?> </h4>
