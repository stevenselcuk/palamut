...
( function() {
	wp.customize.bind( 'ready', function() {
		...
		function customizer_option_display_reverse( parent_setting, affected_control, value ) {
			wp.customize( parent_setting, function( setting ) {
				wp.customize.control( affected_control, function( control ) {
					const visibility = function() {
						if ( value === setting.get() ) {
		...
		function customizer_image_option_display_reverse( parent_setting, affected_control, speed ) {
			wp.customize( parent_setting, function( setting ) {
				wp.customize.control( affected_control, function( control ) {
					const visibility = function() {
						if ( setting.get() && 'none' !== setting.get() && '0' !== setting.get() ) {
